...
@testset "Bolivia" begin
    ...
    holidays = Date[
        ...
        Date(1970, 8, 6), # Independence Day
        ...
        Date(1971, 8, 6), # Independence Day
        ...
        Date(1972, 8, 6), # Independence Day
        ...
        Date(1973, 8, 6), # Independence Day
        ...
        Date(1974, 8, 6), # Independence Day
        ...
        Date(1975, 8, 6), # Independence Day
        ...
        Date(1976, 8, 6), # Independence Day
        ...
        Date(1977, 8, 6), # Independence Day
        ...
        Date(1978, 8, 6), # Independence Day
        Date(1978, 8, 7), # Independence Day (observed)
        ...
        Date(1979, 8, 6), # Independence Day
        ...
        Date(1980, 8, 6), # Independence Day
        ...
        Date(1981, 8, 6), # Independence Day
        ...
        Date(1982, 8, 6), # Independence Day
        ...
        Date(1983, 8, 6), # Independence Day
        ...
        Date(1984, 8, 6), # Independence Day
        ...
        Date(1985, 8, 6), # Independence Day
        ...
        Date(1986, 8, 6), # Independence Day
        ...
        Date(1987, 8, 6), # Independence Day
        ...
        Date(1988, 8, 6), # Independence Day
        ...
        Date(1989, 8, 6), # Independence Day
        Date(1989, 8, 7), # Independence Day (observed)
        ...
        Date(1990, 8, 6), # Independence Day
        ...
        Date(1991, 8, 6), # Independence Day
        ...
        Date(1992, 8, 6), # Independence Day
        ...
        Date(1993, 8, 6), # Independence Day
        ...
        Date(1994, 8, 6), # Independence Day
        ...
        Date(1995, 8, 6), # Independence Day
        Date(1995, 8, 7), # Independence Day (observed)
        ...
        Date(1996, 8, 6), # Independence Day
        ...
        Date(1997, 8, 6), # Independence Day
        Date(1997, 11, 2), # All Souls' Day
        Date(1997, 11, 3), # All Souls' Day (observed)
        ...
        Date(1998, 8, 6), # Independence Day
        ...
        Date(1999, 8, 6), # Independence Day
        ...
        Date(2000, 8, 6), # Independence Day
        Date(2000, 8, 7), # Independence Day (observed)
        ...
        Date(2001, 8, 6), # Independence Day
        ...
        Date(2002, 8, 6), # Independence Day
        ...
        Date(2003, 8, 6), # Independence Day
        Date(2003, 11, 2), # All Souls' Day
        Date(2003, 11, 3), # All Souls' Day (observed)
        ...
        Date(2004, 8, 6), # Independence Day
        ...
        Date(2005, 8, 6), # Independence Day
        ...
        Date(2006, 8, 6), # Independence Day
        Date(2006, 8, 7), # Independence Day (observed)
        ...
        Date(2007, 8, 6), # Independence Day
        ...
        Date(2008, 8, 6), # Independence Day
        Date(2008, 11, 2), # All Souls' Day
        Date(2008, 11, 3), # All Souls' Day (observed)
        ...
        Date(2009, 6, 21), # Aymara New Year
        Date(2009, 6, 22), # Aymara New Year (observed)
        Date(2009, 8, 6), # Independence Day
        Date(2009, 11, 2), # All Souls' Day
        Date(2009, 12, 25), # Christmas Day
        Date(2010, 1, 1), # New Year's Day
        Date(2010, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2010, 6, 21), # Aymara New Year
        Date(2010, 8, 6), # Independence Day
        Date(2010, 11, 2), # All Souls' Day
        Date(2010, 12, 25), # Christmas Day
        Date(2011, 1, 1), # New Year's Day
        Date(2011, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2011, 6, 21), # Aymara New Year
        Date(2011, 6, 23), # Corpus Christi
        Date(2011, 8, 6), # Independence Day
        ...
        Date(2012, 1, 22), # Plurinational State Foundation Day
        Date(2012, 1, 23), # Plurinational State Foundation Day (observed)
        Date(2012, 2, 20), # Carnival
        Date(2012, 2, 21), # Carnival
        Date(2012, 4, 6), # Good Friday
        Date(2012, 4, 30), # Labor Day (observed)
        Date(2012, 5, 1), # Labor Day
        Date(2012, 6, 7), # Corpus Christi
        Date(2012, 6, 21), # Aymara New Year
        Date(2012, 8, 6), # Independence Day
        Date(2012, 11, 2), # All Souls' Day
        Date(2012, 12, 25), # Christmas Day
        Date(2013, 1, 1), # New Year's Day
        Date(2013, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2015, 6, 21), # Aymara New Year
        Date(2015, 6, 22), # Aymara New Year (observed)
        Date(2015, 8, 6), # Independence Day
        Date(2015, 11, 2), # All Souls' Day
        Date(2015, 12, 25), # Christmas Day
        Date(2016, 1, 1), # New Year's Day
        Date(2016, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2016, 6, 21), # Aymara New Year
        Date(2016, 8, 6), # Independence Day
        ...
        Date(2017, 1, 22), # Plurinational State Foundation Day
        Date(2017, 1, 23), # Plurinational State Foundation Day (observed)
        ...
        Date(2017, 6, 21), # Aymara New Year
        Date(2017, 8, 6), # Independence Day
        Date(2017, 8, 7), # Independence Day (observed)
        Date(2017, 11, 2), # All Souls' Day
        Date(2017, 12, 25), # Christmas Day
        Date(2018, 1, 1), # New Year's Day
        Date(2018, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2018, 6, 21), # Aymara New Year
        Date(2018, 8, 6), # Independence Day
        Date(2018, 11, 2), # All Souls' Day
        Date(2018, 12, 25), # Christmas Day
        Date(2019, 1, 1), # New Year's Day
        Date(2019, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2022, 6, 21), # Aymara New Year
        Date(2022, 8, 6), # Independence Day
        Date(2022, 10, 17), # National Dignity Day
        ...
        Date(2023, 1, 22), # Plurinational State Foundation Day
        Date(2023, 1, 23), # Plurinational State Foundation Day (observed)
        Date(2023, 2, 20), # Carnival
        Date(2023, 2, 21), # Carnival
        Date(2023, 4, 7), # Good Friday
        Date(2023, 5, 1), # Labor Day
        Date(2023, 6, 8), # Corpus Christi
        Date(2023, 6, 21), # Aymara New Year
        Date(2023, 8, 6), # Independence Day
        Date(2023, 8, 7), # Independence Day (observed)
        Date(2023, 10, 17), # National Dignity Day
        Date(2023, 11, 2), # All Souls' Day
        Date(2023, 12, 25), # Christmas Day
        Date(2024, 1, 1), # New Year's Day
        Date(2024, 1, 22), # Plurinational State Foundation Day
        Date(2024, 2, 12), # Carnival
        Date(2024, 2, 13), # Carnival
        Date(2024, 3, 29), # Good Friday
        Date(2024, 5, 1), # Labor Day
        Date(2024, 5, 30), # Corpus Christi
        Date(2024, 6, 21), # Aymara New Year
        Date(2024, 8, 6), # Independence Day
        Date(2024, 10, 17), # National Dignity Day
        Date(2024, 11, 2), # All Souls' Day
        Date(2024, 12, 25), # Christmas Day
        Date(2025, 1, 1), # New Year's Day
        Date(2025, 1, 22), # Plurinational State Foundation Day
        Date(2025, 3, 3), # Carnival
        Date(2025, 3, 4), # Carnival
        Date(2025, 4, 18), # Good Friday
        Date(2025, 5, 1), # Labor Day
        Date(2025, 6, 19), # Corpus Christi
        Date(2025, 6, 21), # Aymara New Year
        Date(2025, 8, 6), # Independence Day
        Date(2025, 10, 17), # National Dignity Day
        Date(2025, 11, 2), # All Souls' Day
        Date(2025, 12, 25), # Christmas Day
        Date(2026, 1, 1), # New Year's Day
        Date(2026, 1, 22), # Plurinational State Foundation Day
        Date(2026, 2, 16), # Carnival
        Date(2026, 2, 17), # Carnival
        Date(2026, 4, 3), # Good Friday
        Date(2026, 5, 1), # Labor Day
        Date(2026, 6, 4), # Corpus Christi
        Date(2026, 6, 21), # Aymara New Year
        Date(2026, 6, 22), # Aymara New Year (observed)
        Date(2026, 8, 6), # Independence Day
        Date(2026, 10, 17), # National Dignity Day
        Date(2026, 11, 2), # All Souls' Day
        Date(2026, 12, 25), # Christmas Day
        Date(2027, 1, 1), # New Year's Day
        Date(2027, 1, 22), # Plurinational State Foundation Day
        Date(2027, 2, 8), # Carnival
        Date(2027, 2, 9), # Carnival
        Date(2027, 3, 26), # Good Friday
        Date(2027, 5, 1), # Labor Day
        Date(2027, 5, 27), # Corpus Christi
        Date(2027, 6, 21), # Aymara New Year
        Date(2027, 8, 6), # Independence Day
        Date(2027, 10, 17), # National Dignity Day
        Date(2027, 11, 2), # All Souls' Day
        Date(2027, 12, 25), # Christmas Day
        Date(2028, 1, 1), # New Year's Day
        Date(2028, 1, 22), # Plurinational State Foundation Day
        Date(2028, 2, 28), # Carnival
        Date(2028, 2, 29), # Carnival
        Date(2028, 4, 14), # Good Friday
        Date(2028, 5, 1), # Labor Day
        Date(2028, 6, 15), # Corpus Christi
        Date(2028, 6, 21), # Aymara New Year
        Date(2028, 8, 6), # Independence Day
        Date(2028, 8, 7), # Independence Day (observed)
        Date(2028, 10, 17), # National Dignity Day
        Date(2028, 11, 2), # All Souls' Day
        Date(2028, 12, 25), # Christmas Day
        Date(2029, 1, 1), # New Year's Day
        Date(2029, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2029, 6, 21), # Aymara New Year
        Date(2029, 8, 6), # Independence Day
        Date(2029, 10, 17), # National Dignity Day
        Date(2029, 11, 2), # All Souls' Day
        Date(2029, 12, 25), # Christmas Day
        Date(2030, 1, 1), # New Year's Day
        Date(2030, 1, 22), # Plurinational State Foundation Day
        ...
        Date(2030, 6, 21), # Aymara New Year
        Date(2030, 8, 6), # Independence Day
        Date(2030, 10, 17), # National Dignity Day

...
@testset "France" begin
    ...
    holidays = Date[
        ...
        Date(1986, 5, 8), # Ascension Day; Victory Day
        Date(1986, 5, 19), # Whit Monday
        Date(1986, 7, 14), # National Day
        ...
        Date(1989, 5, 8), # Victory Day
        Date(1989, 5, 15), # Whit Monday
        Date(1989, 7, 14), # National Day
        ...
        Date(1997, 5, 8), # Ascension Day; Victory Day
        Date(1997, 5, 19), # Whit Monday
        Date(1997, 7, 14), # National Day
        ...
        Date(2005, 5, 8), # Victory Day
        Date(2005, 7, 14), # National Day
        ...
        Date(2006, 5, 8), # Victory Day
        Date(2006, 5, 25), # Ascension Day
        Date(2006, 7, 14), # National Day
        ...
        Date(2007, 5, 8), # Victory Day
        Date(2007, 5, 17), # Ascension Day
        Date(2007, 7, 14), # National Day
        ...
        Date(2008, 5, 8), # Victory Day
        Date(2008, 5, 12), # Whit Monday
        Date(2008, 7, 14), # National Day
        ...
        Date(2016, 5, 8), # Victory Day
        Date(2016, 5, 16), # Whit Monday
        Date(2016, 7, 14), # National Day
        ...
        Date(2027, 5, 8), # Victory Day
        Date(2027, 5, 17), # Whit Monday
        Date(2027, 7, 14), # National Day

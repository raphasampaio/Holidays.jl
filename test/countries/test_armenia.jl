...
@testset "Armenia" begin
    calendar = Holidays.Armenia()
    ...
    holidays = Date[
        ...
        Date(2010, 1, 3), # New Year's Day
        Date(2010, 1, 4), # New Year's Day
        Date(2011, 1, 1), # New Year's Day
        Date(2011, 1, 2), # New Year's Day
        Date(2011, 1, 3), # New Year's Day
        Date(2011, 1, 4), # New Year's Day
        Date(2012, 1, 1), # New Year's Day
        Date(2012, 1, 2), # New Year's Day
        Date(2012, 1, 3), # New Year's Day
        Date(2012, 1, 4), # New Year's Day
        Date(2013, 1, 1), # New Year's Day
        Date(2013, 1, 2), # New Year's Day
        Date(2013, 1, 3), # New Year's Day
        Date(2013, 1, 4), # New Year's Day
        Date(2014, 1, 1), # New Year's Day
        Date(2014, 1, 2), # New Year's Day
        Date(2014, 1, 3), # New Year's Day
        Date(2014, 1, 4), # New Year's Day
        Date(2015, 1, 1), # New Year's Day
        Date(2015, 1, 2), # New Year's Day
        Date(2015, 1, 3), # New Year's Day
        Date(2015, 1, 4), # New Year's Day
        Date(2016, 1, 1), # New Year's Day
        Date(2016, 1, 2), # New Year's Day
        Date(2016, 1, 3), # New Year's Day
        Date(2016, 1, 4), # New Year's Day
        Date(2017, 1, 1), # New Year's Day
        Date(2017, 1, 2), # New Year's Day
        Date(2017, 1, 3), # New Year's Day
        Date(2017, 1, 4), # New Year's Day
        Date(2018, 1, 1), # New Year's Day
        Date(2018, 1, 2), # New Year's Day
        Date(2018, 1, 3), # New Year's Day
        Date(2018, 1, 4), # New Year's Day
        Date(2019, 1, 1), # New Year's Day
        Date(2019, 1, 2), # New Year's Day
        Date(2019, 1, 3), # New Year's Day
        Date(2019, 1, 4), # New Year's Day
        Date(2020, 1, 1), # New Year's Day
        Date(2020, 1, 2), # New Year's Day
        Date(2020, 1, 3), # New Year's Day
        Date(2020, 1, 4), # New Year's Day
        Date(2021, 1, 1), # New Year's Day
        Date(2021, 1, 2), # New Year's Day
        Date(2021, 1, 3), # New Year's Day
        Date(2021, 1, 4), # New Year's Day

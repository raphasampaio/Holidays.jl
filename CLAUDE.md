...
Example holiday definition:
```julia
Holiday("New Year's Day", is_january_1st, start_year = 1975, observed = next_monday_if_falls_on_weekend)
```
...
For complex observance patterns (like UK holidays), custom observance functions may be needed.
